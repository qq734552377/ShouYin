 ...
 */
public class MyCircularImageView extends android.support.v7.widget.AppCompatImageView {
    private float width;
    ...
    public MyCircularImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyCircularImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
